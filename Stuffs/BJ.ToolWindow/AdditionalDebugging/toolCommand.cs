...
namespace AdditionalDebugging
{
    ...
    internal sealed class toolCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("bd65a359-8699-42fb-be90-9c35acda6805");
        ...
        {
            // Switch to the main thread - the call to AddCommand in toolCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(tool), 0, true, this.package.DisposalToken);
